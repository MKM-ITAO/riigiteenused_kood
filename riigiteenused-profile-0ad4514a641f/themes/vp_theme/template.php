...
function vp_theme_preprocess_page(&$variables) {
  if (drupal_is_front_page()) {
    ...
    if (isset($variables['page']['content'])
      && isset($variables['page']['content']['content'])
      && isset($variables['page']['content']['content']['content'])
      && is_array($variables['page']['content'])
      && is_array($variables['page']['content']['content'])
      && is_array($variables['page']['content']['content']['content'])
    ) {
...
// Remove the sticky header form tables 
function vp_theme_js_alter(&$js) {
  unset($js['misc/tableheader.js']);
  unset($js['misc/tabledrag.js']);
}
